...
namespace Linq
{
    ...
    public static class SortingData
    {
        ...
        public static IEnumerable<string> OrderBy()
        {
            ...
            IEnumerable<string> ordered = from word in words
        ...
        public static IEnumerable<Product> OrderByProducts()
        {
            ...
            IEnumerable<Product> ordered = from product in products
        ...
        public static IEnumerable<string> OrderByWithCustomComparer()
        {
            ...
            IEnumerable<string> ordered = words.OrderBy(x => x);
        ...
        public static IEnumerable<double> OrderByDescending()
        {
            ...
            IEnumerable<double> ordered = doubles.OrderByDescending(x => x);
            return ordered;
        }
        ...
        public static IEnumerable<string> DescendingCustomComparer()
        {
            ...
            var ordered = words.OrderByDescending(x => x);
            return ordered;
        }
        ...
        public static IEnumerable<string> ThenByCustom()
        {
            ...
            return words.OrderBy(w=>w.Length).ThenBy(w=>w);
        }
        ...
        {
            string[] words = { "aPPLE", "AbAcUs", "bRaNcH", "BlUeBeRrY", "ClOvEr", "cHeRry" };
            return words.OrderBy(w => w.Length).ThenByDescending(w => w);
        }
