...
namespace Linq
{
    ...
    public static class SequenceOperations
    {
        ...
        public static IEnumerable<int> ConcatSeries()
        {
            ...
            var gathered = numbersA.Concat(numbersB);
            return gathered;
        ...
        public static IEnumerable<string> ConcatProjection()
        {
            ...
            var gathered = customers.Select(c=> c.CompanyName).Concat(products.Select(c=> c.ProductName));
        ...
        public static int DotProduct()
        {
            ...
            int result = vectorA.Zip(vectorB, (x, y) => x*y).Sum();
