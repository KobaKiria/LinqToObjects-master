...
namespace Linq
{
    ...
    public static class ElementOperations
    {
        ...
        public static Product FirstElement()
        {
           ...
           return products.FirstOrDefault(p=> p.ProductId ==11);
        }
        ...
        public static string FirstMatchingElement()
        {
            ...
            var element = (from number in strings
                           where number.StartsWith("o")
        ...
        public static int ElementAtPosition()
        {
            ...
            var element =from number in numbers
                          where number > 5
                          select number;
            int myElement = element.ElementAtOrDefault(1);
            return myElement;
        }
        ...
        public static string LastMatchingElement()
        {
            ...
            string element = strings.LastOrDefault(element=> element.Contains("o"));
            return element;
        ...
        public static string SingleMoreThanOneMatchingElement()
        {
            ...
            string element = strings.SingleOrDefault(element => element.Contains("o"));
            if (strings.Count(element => element.Contains("o")) >1)
                throw new InvalidOperationException("more than one such element exists.");
        ...
        public static string MaybeSingleMatchingElement()
        {
            ...
            if (strings.Count(element => element.Contains("o")) != 1)
                return null;
            return strings.SingleOrDefault(e => e.Contains("o"));
